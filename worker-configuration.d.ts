/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7a7976519bd3b0b065837d511db30616)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'LOG_LEVEL' | 'DATABASE_URL' | 'ENVIRONMENT' | 'MERGE_API_KEY'>> {}
}
