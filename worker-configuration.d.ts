/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6d123e3fd8eb3f1dd64206a86fec8917)
...
declare namespace Cloudflare {
	interface Env {
		...
		MERGE_WEBHOOK_SECRET: string;
		BATCH_COORDINATOR: DurableObjectNamespace /* BatchCoordinator from integration-service */;
		integration_files: R2Bucket;
		MERGE_EVENTS_QUEUE: Queue;
	}
}
