...
export class ProcessWebhookUseCase {
	...
	async execute(request: InputWebhook): Promise<string> {
		...
		// // TODO: The logic of this use-case should be handled asynchronously in a message queue. This is just a POC implementation.
		//
		...
		// 			const storageKey = this.generateStorageKey(metadata.originalName);
		//
